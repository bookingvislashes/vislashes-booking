      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <textarea
            id="otherComplaints"
            rows={2}
            className="w-full bg-white border border-light-tan rounded-control px-3 py-2.5 text-[14px] text-charcoal font-sans placeholder:text-muted focus:outline-none focus:border-deep-brown transition-colors resize-none"
