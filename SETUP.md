...
5. Expand **Environment Variables** and add each of these:
   ...
   | `OWNER_NOTIFICATION_EMAIL` | optional — leave out and her blind copy of each booking goes to "Your Inbox" in Settings |
   | `RESCHEDULE_LINK_SECRET` | optional — signs the reschedule links; falls back to the service-role key |
